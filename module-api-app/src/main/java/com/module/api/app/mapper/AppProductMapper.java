...
public interface AppProductMapper extends BaseMapper<AppProduct> {
     ...
     * @return
     */
    IPage<AppProduct> listOfShelf(Page page, @Param("status")Integer status,@Param("keyWord")String keyWord);


    IPage<AppProduct> listOfBuyStatus(Page page,@Param("keyWord")String keyWord,@Param("reserve") Integer reserve);
